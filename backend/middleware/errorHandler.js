...
const errorHandler = (err, req, res, next) => {
  ...
  if (err.name === 'SequelizeForeignKeyConstraintError') {
    error = { message: 'Referenced resource not found or cannot be deleted due to existing references.', statusCode: 400 };
  }

  // Sequelize database error (e.g., invalid input)
  if (err.name === 'SequelizeDatabaseError') {
    error = { message: 'Database error: ' + err.message, statusCode: 400 };
  }
